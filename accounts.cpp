...
accounts::accounts(int Account_id,int Amount,int Password)
:reader_writer_user_account(),password(Password) {
	account_id = Account_id;
	amount = Amount;
	lock_reader = new pthread_mutex_t();
	lock_writer = new pthread_mutex_t();
